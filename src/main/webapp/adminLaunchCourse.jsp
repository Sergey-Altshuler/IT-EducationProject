...
<body>
<h1> <fmt:message key="label.yourRoleAdmin"/><br> <fmt:message key="label.launchCourse"/></h1>
<br>
<br>
...
<table>
    ...
    <c:forEach var="courses" items="${courses}">
        <tr>
            ...
            <td><a href="adminLaunchCourseServlet?launchId=${courses.id}"> <fmt:message key="label.launchCourse"/> </a> </td>
        </tr>
    </c:forEach>
</table>
</body>
