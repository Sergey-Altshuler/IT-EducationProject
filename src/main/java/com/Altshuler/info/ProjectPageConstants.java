...
public class ProjectPageConstants {
    public static final String PAGE_WRONG_OPERATION = "/wrongOperation.jsp";
    public static final String PAGE_WRONG_DATA = "/wrongData.jsp";
    ...
    public static final String PAGE_COACH_CHOOSE_COURSE = "/coachChooseCourse.jsp";
    public static final String PAGE_COACH_PUT_MARKS = "/coachPutMarks.jsp";
    public static final String PAGE_COACH_SUCCESS_REGISTER = "/coachSuccessRegister.jsp";
    public static final String PAGE_CHOOSE_LANGUAGE = "/chooseLanguage.jsp";
